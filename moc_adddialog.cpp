...
QT_MOC_LITERAL(1, 10, 17), // "addGroupOrChannel"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 14), // "stationInvalid"
QT_MOC_LITERAL(4, 44, 12), // "groupInvalid"
QT_MOC_LITERAL(5, 57, 5), // "enter"
QT_MOC_LITERAL(6, 63, 6), // "cancel"
QT_MOC_LITERAL(7, 70, 14) // "importFromFile"

    },
    "addDialog\0addGroupOrChannel\0\0"
    "stationInvalid\0groupInvalid\0enter\0"
    "cancel\0importFromFile"
};
...
void addDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->addGroupOrChannel((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->stationInvalid(); break;
        case 2: _t->groupInvalid(); break;
        case 3: _t->enter(); break;
        case 4: _t->cancel(); break;
        case 5: _t->importFromFile(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (addDialog::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&addDialog::addGroupOrChannel)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void addDialog::addGroupOrChannel(QString _t1, QString _t2)
{
